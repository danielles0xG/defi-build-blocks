...
const BB_CONTRACT = require("../artifacts/contracts/mocks/BBMockNonUpgradable.sol/BBMockNonUpgradable.json");
const { BigNumber } = require("ethers");

const POOL = artifacts.require("ActionPoolDcRouter");
const SIMPLE_VAULT = artifacts.require("BBMock");
const VAULT = artifacts.require("BBMockNonUpgradable");
...
contract("BaseBuildingBlockNonUpgradable", function ([wallet1, relayer]) {
  before(async function () {
    ...
    this.bbImpl = await SIMPLE_VAULT.new(this.pool.address, { from: wallet1 });
    ...
    this.bbb = await VAULT.new(dataForInitialize);
